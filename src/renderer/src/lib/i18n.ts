...
const translations: Record<AppLanguage, Messages> = {
  'zh-CN': {
    ...
    emptyTitle: '还没有截图',
    emptyCopy: '在鼠标所在屏幕拖动选择区域，或导入已有图片并开始 OCR。',
  ...
  en: {
    ...
    statusCapturing: 'Select a capture region',
    ...
    emptyCopy: 'Drag on the display under the pointer, or open an existing image to start OCR.',
